...
import com.carservice.framework.security.filter.BodyReaderHttpServletRequestWrapper;
...
public class TokenService
{
    ...
    private String getToken(HttpServletRequest request)
    {
        ...
        if (StringUtils.isEmpty(token)){
            ...
            if (StringUtils.isEmpty(token)){
                try {
                    JSONObject jsonObject = JSONObject.parseObject(new BodyReaderHttpServletRequestWrapper(request).getBodyString(request));
