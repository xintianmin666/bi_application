    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="100px">
          ...
          <el-select v-model="queryParams.checkreult" placeholder="请选择" clearable size="small">
        ...
        <el-table v-loading="loading" :data="shopList" @selection-change="handleSelectionChange">
          ...
          <!--<el-table-column label="信用积分" align="center" prop="points" />-->
          ...
          <el-table-column label="店铺排序" align="center" prop="shopOrder"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="700px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-row>
          ...
          <el-col :span="12">
            <!--<el-button type="primary" plain icon="el-icon-map-location" @click="getLonLat">获取经纬度</el-button>-->
