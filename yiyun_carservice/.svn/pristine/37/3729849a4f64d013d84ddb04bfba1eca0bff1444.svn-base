package com.yiyun.yiyuncarservice.utils;// import org.apache.commons.io.*;
...
//    try {
//      BufferedReader br =
//          new BufferedReader(new InputStreamReader(connectionData.getInputStream(), "UTF-8"));
...
public class WeatherApi {
   ...
   */
  public static void main(String[] args) {
    String apiURL = "http://wthrcdn.etouch.cn/weather_mini?city=" + "芜湖";
    ResponseEntity<String> respString = restTemplate.getForEntity(apiURL, String.class);
    if (200 == respString.getStatusCodeValue()) {
      System.out.println(respString.getBody());
    } else {
      System.out.println(respString.getStatusCodeValue());
    }
  }
}
